...
public:
	...
	GD_INT_MEMBER(ESPIONAGE_NP_COUNTERSPY_NETWORK); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_COUNTERSPY_PER_RANK); // VP
	...
	GD_INT_MEMBER(ESPIONAGE_XP_MISSION_SUCCESS_DENOMINATOR); // VP
	GD_INT_MEMBER(ESPIONAGE_COUNTERSPY_CHANGE_FOCUS_COOLDOWN); // VP
	GD_INT_MEMBER(ESPIONAGE_IMPRISONMENT_COOLDOWN); // VP
