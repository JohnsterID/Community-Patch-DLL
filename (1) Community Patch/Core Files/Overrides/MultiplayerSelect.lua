...
-- *** GAP DETECTION: This is where the 12-second gap ends ***
local activeModsOnLoad = Modding.GetActivatedMods()
local modCountOnLoad = activeModsOnLoad and #activeModsOnLoad or 0

-- This will show the gap if mods were disabled during network initialization
if modCountOnLoad == 0 then
else
end
