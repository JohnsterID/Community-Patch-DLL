    ...
    try:
        for cpp in CPP:
            ...
            if analyze:
                ...
                # Use --analyzer-output plist-multi-file with LLVM 22.1.4
...
# Use LLVM 22.1.4 for better --plist-multi-file support
llvm_path = os.environ.get('LLVM_PATH', '/tmp/LLVM-22.1.4-Linux-X64')
